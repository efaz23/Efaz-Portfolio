...
const typed = new Typed(".multiple-text", {
  strings: ["IT support Specialist ", "Front-End Developer", "Software Developer"],
  typeSpeed: 100,
  backSpeed: 100,
  backDelay: 1000,
  loop: true,
...
function sendEmail(event) {
  ...
  emailjs.init("Khg1bJqIJrO5xfZyP"); 
  emailjs.send("efazuddin12", "template_y87vzph", templateParams).then(
    function (response) {
